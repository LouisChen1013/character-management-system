...
class Player(AbstractCharacter):
    ...
    def get_details(self):
        ...
        details = f"The player (id: {self.id}) is level {self.get_level()} {self.get_job()} with {self.health} health and {self.damage} damage, Position: X = {self.get_position()[0]} Y = {self.get_position()[1]}"
        return details
